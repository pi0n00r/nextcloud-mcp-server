...
- **calendar**: allow all-calendar event searches without a calendar name while
  requiring one for scoped searches

## v0.140.4 (2026-07-17)

### Fix

- **deck**: persist due dates while preserving their UTC instant and card order
